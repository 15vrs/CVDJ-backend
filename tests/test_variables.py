...
# Playback test variables.
PLAYBACK_DATA = {
    'context': {
        'uri': 'spotify:playlist:6rzDJ7iqTwKjVsqHf7oxTy'
    },
    'progress_ms': 52620,
    'item': {
        'album': {
            'images': [
                {'url': 'https://i.scdn.co/image/ab67616d0000b273f6a63a9dbf0f1c388db690fc'}
            ]
        },
        'artists': [
            {'name':'Big Sean'},
...
SONG = 'I Know'
ARTIST = 'Big Sean'
ALBUM_ART = 'https://i.scdn.co/image/ab67616d0000b273f6a63a9dbf0f1c388db690fc'